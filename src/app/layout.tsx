  ...
  return (
    <html lang="en">
      <Head>
        ...
        />
        <meta name="description" content="Network X Group" />
        <meta name="author" content="Jonty Coertzen" />

        <title>Network X Group</title>
        ...
        <link
          ...
          type="image/png"
          sizes="72x72"
          href="img/favicons/icon-72x72.png"
        />
        <link rel="manifest" href="img/favicons/site.webmanifest" />
        <link
          rel="shortcut icon"
          type="image/png"
          href="img/favicons/icon-512x512.png"
        />
                    ...
                    <div className="container">
                      ...
                      <div className="row">
                        <div className="col-12">
                          <img
                            src="assets/img/logo-white-gold.png"
                        ...
                        <div className="col-lg-4">
                          <div className="award-item">
                            <div className="award-item-logo">
                              <img src="assets/img/network-x.png" alt="" />
                            </div>
	...
	c0.7,0.5,1.5,0.7,2.3,0.7c0.8,0,1.6-0.2,2.3-0.7l23.4-15v29.7C57.8,49.2,57,49.9,56,49.9z"
		...
		c1.2,0,2.2,1,2.2,2.2v29.7c0,1.2-1,2.2-2.2,2.2s-2.2-1-2.2-2.2V20.5L16.6,50.7C16.2,51.1,15.6,51.3,15,51.3z"
                        ...
                        <div className="col-lg-4">
                          <div className="award-item">
                            <div className="award-item-logo">
                              <img src="assets/img/nxd.png" alt="" />
                            </div>
                            <div className="award-item-title slide-title-sub">
                              Digital Marketing
                            </div>
	...
	c0.7,0.5,1.5,0.7,2.3,0.7c0.8,0,1.6-0.2,2.3-0.7l23.4-15v29.7C57.8,49.2,57,49.9,56,49.9z"
		...
		c1.2,0,2.2,1,2.2,2.2v29.7c0,1.2-1,2.2-2.2,2.2s-2.2-1-2.2-2.2V20.5L16.6,50.7C16.2,51.1,15.6,51.3,15,51.3z"
                        ...
                        <div className="col-lg-4">
                          <div className="award-item">
                            <div className="award-item-logo">
                              <img src="assets/img/mettlestate.png" alt="" />
                            </div>
                            <div className="award-item-title slide-title-sub">
                              Esports and Gaming
                            </div>
	...
	c0.7,0.5,1.5,0.7,2.3,0.7c0.8,0,1.6-0.2,2.3-0.7l23.4-15v29.7C57.8,49.2,57,49.9,56,49.9z"
		...
		c1.2,0,2.2,1,2.2,2.2v29.7c0,1.2-1,2.2-2.2,2.2s-2.2-1-2.2-2.2V20.5L16.6,50.7C16.2,51.1,15.6,51.3,15,51.3z"
                        ...
                        <div className="col-lg-4">
                          <div className="award-item">
                            <div className="award-item-logo">
                              <img src="assets/img/lucky-hustle.png" alt="" />
                            </div>
                            <div className="award-item-title slide-title-sub">
                              Creative Agency
                            </div>
	...
	c0.7,0.5,1.5,0.7,2.3,0.7c0.8,0,1.6-0.2,2.3-0.7l23.4-15v29.7C57.8,49.2,57,49.9,56,49.9z"
		...
		c1.2,0,2.2,1,2.2,2.2v29.7c0,1.2-1,2.2-2.2,2.2s-2.2-1-2.2-2.2V20.5L16.6,50.7C16.2,51.1,15.6,51.3,15,51.3z"
                        ...
                        <div className="col-lg-4">
                          <div className="award-item">
                            <div className="award-item-logo">
                              <img src="assets/img/strat-farm.png" alt="" />
                            </div>
                            <div className="award-item-title slide-title-sub">
                              Media Strategy
                            </div>
	...
	c0.7,0.5,1.5,0.7,2.3,0.7c0.8,0,1.6-0.2,2.3-0.7l23.4-15v29.7C57.8,49.2,57,49.9,56,49.9z"
		...
		c1.2,0,2.2,1,2.2,2.2v29.7c0,1.2-1,2.2-2.2,2.2s-2.2-1-2.2-2.2V20.5L16.6,50.7C16.2,51.1,15.6,51.3,15,51.3z"
                        ...
                        <div className="col-lg-4">
                          <div className="award-item">
                            <div className="award-item-logo">
                              <img src="assets/img/kasi-kulcha.png" alt="" />
                            </div>
                            <div className="award-item-title slide-title-sub">
